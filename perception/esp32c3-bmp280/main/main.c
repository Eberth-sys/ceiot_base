...
//static char *BODY = "id="DEVICE_ID"&t=%0.2f&h=%0.2f"; ## Comento la linea original.
static char *BODY = "id="DEVICE_ID"&t=%0.2f&h=%0.2f&p=%0.2f"; // Agrego  la linea  moficiada 
...
//            if (bme280p) {
		...
		//sprintf(body, BODY, temperature , humidity ); ### Linea original
		sprintf(body, BODY, temperature , humidity, pressure ); // Linea modificada  ########################
